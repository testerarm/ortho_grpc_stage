# functions for identifying images are withing a certain range 
# or not within a certain range
import logging
...
#opensfm detect features function: images is title of image , data is memory location of image
def detect(args):
    image, data = args
    print('detect')
    print(image)
